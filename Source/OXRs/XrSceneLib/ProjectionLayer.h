...
#include <functional>
#include <OXRs/XrUtility/XrStereoView.h>
...
namespace xr {
    ...
    public:
        ...
        void PrepareRendering(const XrContext& context,
                              XrViewConfigurationType viewConfigType,
                              const std::vector<XrViewConfigurationView>& viewConfigViews);

        bool Render(XrContext& context,
    ...
    private:
        struct ViewConfigComponent {
            ...
            DX::SwapchainD3D11 ColorSwapchain;
            DX::SwapchainD3D11 DepthSwapchain;
        };
    ...
    public:
        ...
        void Resize(uint32_t size, XrContext& context, bool forceReset = false) {
            std::lock_guard lock(m_mutex);
