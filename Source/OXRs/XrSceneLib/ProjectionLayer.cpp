...
void ProjectionLayer::PrepareRendering(const XrContext& context,
...
bool ProjectionLayer::Render(XrContext& context,
    ...
    const DX::SwapchainD3D11& colorSwapchain = viewConfigComponent.ColorSwapchain;
    const DX::SwapchainD3D11& depthSwapchain = viewConfigComponent.DepthSwapchain;
